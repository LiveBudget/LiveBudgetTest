...
<thead className="sticky top-0 bg-white z-10">
  <tr className="bg-gray-100">
    <th className="w-[60px] overflow-hidden whitespace-nowrap text-ellipsis truncate border border-gray-500 px-1 py-2 text-left">
      Day
    </th>
    <th className="w-[100px] overflow-hidden whitespace-nowrap text-ellipsis truncate border border-gray-500 px-1 py-2 text-left">
      Date
    </th>
    <th className="w-[100px] overflow-hidden whitespace-nowrap text-ellipsis truncate border border-gray-500 px-1 py-2 text-left">
      Balance
...
<tbody>
  {timeline.map((entry, index) => (
    ...
    >
      <td className="w-[60px] overflow-hidden whitespace-nowrap text-ellipsis truncate border border-gray-300 px-1 py-2">
        {entry.date.toLocaleDateString('en-US', { weekday: 'long' })}
      </td>
      <td className="w-[100px] overflow-hidden whitespace-nowrap text-ellipsis truncate border border-gray-300 px-1 py-2">
